...
export const metadata: Metadata = {
  title: "Black Coffee - Premium Freshly Roasted Coffee Shop",
  description: "Experience the finest freshly roasted coffee beans, expertly crafted by professional baristas. Subscribe to premium coffee delivery service.",
  keywords: "coffee shop, freshly roasted coffee, premium coffee beans, barista, coffee subscription, espresso, latte, mocha",
  metadataBase: undefined,
  alternates: undefined,
  openGraph: {
    title: "Black Coffee - Premium Freshly Roasted Coffee",
    description: "Experience the finest freshly roasted coffee beans, expertly crafted by professional baristas.",
    siteName: "Black Coffee",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763394159196-v57c434b.jpg",
  ...
  twitter: {
    ...
    title: "Black Coffee - Premium Freshly Roasted Coffee",
    description: "Experience the finest freshly roasted coffee beans, expertly crafted by professional baristas.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763394159196-v57c434b.jpg"]
  },
  robots: {
    index: true,
    follow: true
